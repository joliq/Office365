...
function initializePage() {
    ...
    employeeList = clientContext.get_web().get_lists().getByTitle('New Employees In Gothenburg');
    completedItems;
}
...
function scheduleAsNeeded() {
    ...
    while (listItemEnumerator.moveNext()) {
        ...
        if (alreadyScheduled === false) {
            ...
            itemToCreate.set_item('EventDate', '2016-03-' + dayOfMonth + 'T21:00:00Z');
            itemToCreate.set_item('EndDate', '2016-03-' + dayOfMonth + 'T23:00:00Z');
            dayOfMonth++;
